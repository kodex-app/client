// NOTE (Kodex): dropped `import 'construct-style-sheets-polyfill'` — constructable stylesheets are
// natively supported in the browsers we target, and the polyfill isn't vendored.
