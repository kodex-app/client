...
import dev.icedtea.kodex.network.FilterListDto
import dev.icedtea.kodex.network.GroupFilter
import dev.icedtea.kodex.network.HeaderFilter
import dev.icedtea.kodex.network.KodexApi
import dev.icedtea.kodex.network.LibraryDto
import dev.icedtea.kodex.network.SelectFilter
import dev.icedtea.kodex.network.SeparatorFilter
import dev.icedtea.kodex.network.SeriesPage
import dev.icedtea.kodex.network.SortFilter
import dev.icedtea.kodex.network.SortSelection
import dev.icedtea.kodex.network.SourceDescriptor
import dev.icedtea.kodex.network.SourceFilter
...
import dev.icedtea.kodex.ui.Tip
...
fun SourceFeedScreen(
    ...
    dev.icedtea.kodex.platform.AppBackHandler(enabled = selection.active) { selection.clear() }
